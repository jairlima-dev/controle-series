<template>
    ...
    <div class="container mx-auto">
        ...
        <main class="flex h-screen pb-6 rounded-sm">
            <aside v-if="this.$store.state.token" class="max-h-screen bg-gray-600 text-white py-4 px-4 w-1/5 rounded-2xl cursor-pointer">
...
<script>
    ...
    export default {
        ...
        methods: {
            handleLogout() {
                api.logout(this.$store.state.token)
                .then((response) => {
