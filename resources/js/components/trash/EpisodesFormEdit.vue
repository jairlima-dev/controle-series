...
<!--                <label class="block" for="assistido">Assistido - {{ episodio.assistido }}</label>-->
...
<script>
    ...
    import TagTitle from "../shared/tag-title";
    import Message from "../shared/message";
    import ButtonAction from "../shared/button-action";
    import CheckedDefault from "../shared/checked-default"

    export default {
        name: "EpisodesEdit",
        components: {Message, CheckedDefault, ButtonAction, TagTitle, DivContainer},
